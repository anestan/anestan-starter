...
// Project related.
var project                 = 'anestan'; // Project Name.
var projectURL              = 'http://localhost:8888/anestan/'; // Project URL. Could be something like localhost:8888.
var productURL              = './'; // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.

// Translation related.
var text_domain             = 'anestan'; // Your textdomain here.
var destFile                = 'anestan.pot'; // Name of the transalation file.
var packageName             = 'anestan'; // Package name.
var bugReport               = 'anestan <anes.tan@gmail.com>'; // Where can users report bugs.
var lastTranslator          = 'anestan <anes.tan@gmail.com>'; // Last translator Email ID.
var team                    = 'anestan <anes.tan@gmail.com>'; // Team's Email ID.
var translatePath           = './languages' // Where to save the translation files.

// Style related.
var styleSRC                = './raw/scss/style.scss'; // Path to main .scss file.
...
// Images related.
var imagesSRC               = './raw/images/**/*.{png,jpg,gif,svg}'; // Source folder of images which should be optimized.
var imagesDestination       = './images/'; // Destination folder of optimized images. Must be different from the imagesSRC folder.

// Watch files paths.
var styleWatchFiles         = './raw/scss/**/*.scss'; // Path to all *.scss files inside css folder and inside them.
...
var csscomb      = require('gulp-csscomb'); // sort css definitions.
